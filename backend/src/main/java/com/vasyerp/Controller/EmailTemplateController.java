...
//
//    public EmailTemplateController(SessionKeyStore sessionKeyStore, TemplateService<EmailTemplate> templateService) {
...
//
//        Page<EmailTemplate> page = templateService.list(request.getSearch(), request.getPage(), request.getSize());
//
